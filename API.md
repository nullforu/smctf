...
All fields are optional. Only provided fields are validated and updated. `flag` cannot be changed via this endpoint.
...
{
    "error": "invalid input",
    "details": [{ "field": "body", "reason": "invalid json" }]
}
```
...
{
    "error": "invalid input",
    "details": [{ "field": "flag", "reason": "required" }]
}
```
